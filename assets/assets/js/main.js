...
const shadowHeader=()=>{
    ...
    //add a class if the bottom ofset is greadter than 50 
...
const scrollUp=()=>{
    ...
    //when the scroll is higher than the 350 viewport height,add the show-scroll clas to the tag with the scrollup class
